<div>
        ...
        <div class="col-md-7 col-12 col-lg-8 order-1 g-3">
            <div class="card">
                <div class="card-body d-flex flex-column">
                    <span class="fw-bold">Informasi Pengabdian: Pengabdian A</span>
                    <span class="text-muted">
                        Kaprodi dapat menyetujui / menolak pengabdian yang diajukan oleh dosen.
                    </span>
                </div>
            </div>
        </div>
                    ...
                    <div class="demo-inline-spacing mt-3">
                        <div class="list-group list-group-flush">
                            <span class="list-group-item list-group-item-action">Ketua Kelompok: Dosen A (Fakultas
                                A)</span>
                            <span class="list-group-item list-group-item-action">Judul: Pengabdian A</span>
                            <span class="list-group-item list-group-item-action">Bidang Fokus: Bidang 1, Bidang 2</span>
                            <span class="list-group-item list-group-item-action">Jenis Pengabdian: Pengabdian</span>
    ...
    <div class="row mt-4">
        <div class="col-12 mb-2">
            <div class="card">
                <div class="card-body d-flex flex-column">
                    <span class="fw-bold">Dokumen Pengabdian</span>
                    <span class="text-muted">
                        ...
                        <table class="table table-striped table-bordered">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th>Proposal</th>
                                    <th>Kontrak Pengabdian</th>
                                    <th>Kelompok Pengabdian</th>
